...
(function() {
  $(function() {
    var Classifier, Point, ans, ans_w, boundary, canvas, canvas_static, convert_x, convert_y, counter, ctx, ctx_static, cycle, draw, finish, fps, get_params, height, init, m, max_x, max_y, min_x, min_y, points, points_num, scale_x, scale_y, update, width;
    m = Math;
