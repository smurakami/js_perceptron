...
(function() {
  $(function() {
    var Classifier, Point, ans, boundary, canvas, canvas_static, center, counter, ctx, ctx_static, cycle, draw, finish, fps, height, i, m, p, param, points, points_num, radius, scale, update, width, _i, _len;
    m = Math;
